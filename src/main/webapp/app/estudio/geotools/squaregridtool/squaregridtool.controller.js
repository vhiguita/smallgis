(function() {
  ...
  angular
  .module('smallgisApp')
  .controller('squaregridtoolController', squaregridtoolController);

  squaregridtoolController.$inject = ['$scope', '$element','geoOperation','leafletData','$rootScope'];

  function squaregridtoolController($scope, $element,geoOperation,leafletData,$rootScope){
          ...
          if(fcgj!=null){
            leafletData.getMap().then(function(map) {
              ...
              if(layerName.length>=10){
                nombreCapa='Square grid ' + layerName.substring(0, 10);//Assign new name for the layer
              }else{
                nombreCapa='Square grid ' + layerName.substring(0, layerName.length);//Assign new name for the layer
              }
