(function() {
  ...
  angular
  .module('smallgisApp')
  .controller('updatetoolController', updatetoolController);

  updatetoolController.$inject = ['$scope', '$element','close','geoOperation','leafletData','$rootScope'];

  function updatetoolController($scope, $element,close,geoOperation,leafletData,$rootScope){
    ...
    $scope.process = function() {
      ...
      if(typeof layerName !== "undefined"){
        ...
        leafletData.getMap("mapabase").then(function(map) {
          ...
          //$scope.clcontrol.addOverlay(fcgj.addTo(map), 'Update ' + layerName.substring(0, 10));
          var nombreCapa='';
          if(layerName.length>=10){
            nombreCapa='Update ' + layerName.substring(0, 10);//Assign new name for the layer
          }else{
            nombreCapa='Update ' + layerName.substring(0, layerName.length);//Assign new name for the layer
          }
