	...
	L.Routing.Localization = {
		'en': {
			...
			instructions: {
				...
				'Continue':
					['Continuar {dir}', ' sobre {road}'],
				'SlightRight':
					['Leve giro a la derecha', ' sobre {road}'],
				'Right':
					['Hacia la derecha', ' sobre {road}'],
				'SharpRight':
					['Giro prenunciado a la derecha', ' sobre {road}'],
				'TurnAround':
					['Dar vuelta'],
				'SharpLeft':
					['Giro pronunciado a la izquierda', ' sobre {road}'],
				'Left':
					['hacia la izquierda', ' sobre {road}'],
				'SlightLeft':
					['Leve giro a la izquierda', ' onto {road}'],
				'WaypointReached':
					['Punto de interes alcanzado'],
				'Roundabout':
					['Tome la {exitStr} salida', ' sobre {road}'],
				'DestinationReached':
					['Destino alcanzado'],
			},
