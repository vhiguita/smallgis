...
import com.smallgis.app.repository.AuthorityRepository;
import com.smallgis.app.repository.UserRepository;
import com.smallgis.app.security.AuthoritiesConstants;
import com.smallgis.app.service.MailService;
import com.smallgis.app.service.UserService;
import com.smallgis.app.web.rest.dto.ManagedUserDTO;
...
public class UserResource {
    ...
    public ResponseEntity<ManagedUserDTO> updateUser(@RequestBody ManagedUserDTO managedUserDTO) {
        ...
        return userRepository
            ...
            .map(user -> {
                ...
                user.setBusinessType(managedUserDTO.getBusinessType());
                user.setBusinessCode(managedUserDTO.getBusinessCode());
                user.setBusinessName(managedUserDTO.getBusinessName());
                user.setCountryCode(managedUserDTO.getCountryCode());
                user.setActivated(managedUserDTO.isActivated());
                user.setIsAdmin(managedUserDTO.getIsAdmin());
                user.setUserPlan(managedUserDTO.getUserPlan());
    ...
    @RequestMapping(value = "/users/{companyCode}",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<User>> getAllUsersByCompanyCode(@PathVariable String companyCode) {
    ...
    @RequestMapping(value = "/users/getAllUsersByCode/{companyCode}",
    method = RequestMethod.GET,
    produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<User>> getAllUsersByCode(@PathVariable String companyCode) {
        List<User> users = userService.getAllUsersByCode(companyCode);
    ...
    @RequestMapping(value = "/users/{login}/{state}",
        method = RequestMethod.PUT,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Void> updateUserState(@PathVariable String login,@PathVariable boolean state) {
        userService.updateUserState(login,state);
