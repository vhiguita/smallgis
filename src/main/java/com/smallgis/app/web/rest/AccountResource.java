...
import com.smallgis.app.web.rest.dto.KeyAndPasswordDTO;
import com.smallgis.app.web.rest.dto.ManagedUserDTO;
import com.smallgis.app.web.rest.dto.UserDTO;
...
public class AccountResource {
        ...
        return userRepository.findOneByLogin(managedUserDTO.getLogin().toLowerCase())
            ...
            .orElseGet(() -> userRepository.findOneByEmail(managedUserDTO.getEmail())
                ...
                .orElseGet(() -> {
                    ...
                    managedUserDTO.getBusinessType(), managedUserDTO.getBusinessCode(), managedUserDTO.getBusinessName(), managedUserDTO.getCountryCode(), managedUserDTO.getUserPlan(), managedUserDTO.getIsAdmin(), managedUserDTO.getLangKey());
    ...
    public ResponseEntity<String> saveAccount(@Valid @RequestBody UserDTO userDTO) {
        ...
        return userRepository
            ...
            .map(u -> {
                userService.updateUserInformation(userDTO.getFirstName(), userDTO.getLastName(), userDTO.getEmail(), userDTO.getBusinessName(), userDTO.getCountryCode(),userDTO.getLangKey());
